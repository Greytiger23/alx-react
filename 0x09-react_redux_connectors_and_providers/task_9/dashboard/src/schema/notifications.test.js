...
test('getAllNotificationsByUser returns the correct notifications for user id 5debd764a7c57c7839d722e9', () => {
...
test('normalized data has correct users entity', () => {
  ...
  expect(normalizedData.entities.user["5debd764a7c57c7839d722e9"]).toEqual(expectedUser);
});
